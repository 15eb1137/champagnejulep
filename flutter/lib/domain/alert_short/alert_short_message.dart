...
class AlertShortMessage with _$AlertShortMessage {
  ...
  factory AlertShortMessage.create(ChangeInBalance changeInBalance, int threshold) => AlertShortMessage(
      '${DateFormat.yMMMMd().format(changeInBalance.date)}に$threshold円を下回る予定です。');
}
